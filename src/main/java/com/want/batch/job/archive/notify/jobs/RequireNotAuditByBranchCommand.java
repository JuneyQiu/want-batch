 ...
 */
@Component
public class RequireNotAuditByBranchCommand extends AbstractNotifyCommand {

	@Override
	protected List<NotifyBo> queryResults() {
		// TODO Auto-generated method stub
		Map<String,String> ruleMap=getRuleMap();
		return (ruleMap==null)?new ArrayList<NotifyBo>():getNotifyBoOfRequireNotAuditByBranch(ruleMap);
	}

	/**
	 * 规则四：
	 * 1.从9日00:01--9日23:59止，检查营业所客户货需未审核
	 * 2.当月只能录下个月的货需
	 */
	...
	/** 营业所客户货需未确认：所有异常客户及关系人
	 * 货需只有四个渠道需要录：强网三个+县城，2010-08-09
	 * @param ruleMap
	 * @return
	 */
	private List<NotifyBo> getNotifyBoOfRequireNotAuditByBranch(Map<String,String> ruleMap){
		StringBuffer buf=new StringBuffer("");
		buf.append("select distinct  ?  as abnormality_type ")
			.append(",'营业所客户货需未审核' as abnormality_des ")
			...
			.append(" where b.sz_status='0' and b.require_year=? and b.require_month=? ");

		return this.getiCustomerJdbcOperations().query(buf.toString(),new NotifyBoRowMapper(),new Object[]{
			Constant.EXC_TYPE_CODE_REQUIRE_UNAUDIT_BY_BRANCH,ruleMap.get("IS_FIRST_TIME"),ruleMap.get("START_YMD")
			,Constant.EXC_TYPE_CODE_REQUIRE_UNAUDIT_BY_BRANCH,ruleMap.get("COMPARE_YEAR"),ruleMap.get("COMPARE_MONTH")});
	}
}
