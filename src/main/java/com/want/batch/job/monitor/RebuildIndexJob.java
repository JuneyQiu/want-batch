...
public class RebuildIndexJob extends AbstractWantJob{
	private static final String PROPERTIESNAME = "project";
	private static final String SCHEMAPARAMETER = "rebuildIndex.schedule.schedule.parameter";
	...
	public void execute() throws Exception {
		...
		.append("<html><body> <span style='color:#228B22'> Dear All:</span> <br> <hr>" +
				...
				"<br><span style='color:#228B22'>重建范围：10.0.0.34、10.0.0.181 、10.0.1.65、10.0.0.42</span>"+
				"</body></html>")
		.toString();
