...
import com.want.batch.job.old.SyncDailyReportNew;

public class syncDailyReportNewTest {
	...
	public void executeTest() {
		try {
			...
			SyncDailyReportNew syncDailyReportNew = ac.getBean(SyncDailyReportNew.class);
			syncDailyReportNew.executeBatch();
