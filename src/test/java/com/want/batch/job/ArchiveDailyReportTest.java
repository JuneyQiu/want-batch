...
import com.want.batch.job.archive.ArchiveDailyReport;

public class ArchiveDailyReportTest {
	...
	public void executeTest() {
		try {
			...
			ArchiveDailyReport archiveDailyReport = ac.getBean(ArchiveDailyReport.class);
			archiveDailyReport.executeBatch();
