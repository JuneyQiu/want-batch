...
import com.want.batch.job.basedata.SyncCustMark;

public class SyncCustMarkTest {
	...
	public void executeTest() {
		try {
			...
			SyncCustMark syncCustMark = ac.getBean(SyncCustMark.class);
			syncCustMark.executeBatch();
