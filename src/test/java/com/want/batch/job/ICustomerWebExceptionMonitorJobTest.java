...
import com.want.batch.job.monitor.ICustomerWebExceptionMonitorJob;

public class ICustomerWebExceptionMonitorJobTest {
	...
	public void executeTest() {	
		try {
			...
			ICustomerWebExceptionMonitorJob job = ac.getBean(ICustomerWebExceptionMonitorJob.class);
			job.executeBatch();
