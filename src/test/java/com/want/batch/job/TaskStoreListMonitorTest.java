...
import com.want.batch.job.monitor.TaskStoreListMonitor;

public class TaskStoreListMonitorTest {
	...
	public void executeTest() {
		try {
			...
			TaskStoreListMonitor taskStoreListMonitor = ac.getBean(TaskStoreListMonitor.class);
			taskStoreListMonitor.executeBatch();
