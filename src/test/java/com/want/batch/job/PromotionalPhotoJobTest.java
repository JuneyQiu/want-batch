...
import com.want.batch.job.business.promotional.PromotionalPhotoJob;

public class PromotionalPhotoJobTest {
	...
	public void executeTest() {
		try {
			...
			PromotionalPhotoJob promotionalPhotoJob = ac.getBean(PromotionalPhotoJob.class);
			promotionalPhotoJob.executeBatch();
