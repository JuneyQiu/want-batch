...
import com.want.batch.job.old.SyncProductCustomerNW;

public class SyncProductCustomerNWTest {
	...
	public void executeTest() {
		try {
			...
			SyncProductCustomerNW syncProductCustomer = ac.getBean(SyncProductCustomerNW.class);
